/*
 * @#ActorNetworkServiceRecord.java - 2016
...
import org.fermat.p2p.server.app.stress.structure.interfaces.IntraUserNotification;
...
public class ActorNetworkServiceRecord implements IntraUserNotification {
    ...
    private ActorNetworkServiceRecord(JsonObject jsonObject, Gson gson) {
        ...
        this.actorSenderProfileImage   = Base64.decodeBase64(jsonObject.get("actorSenderProfileImage").getAsString());
    ...
    public String toJson() {
        ...
        jsonObject.addProperty("actorSenderProfileImage",   Base64.encodeBase64String(actorSenderProfileImage));
    ...
    public String toString() {
        return "ActorNetworkServiceRecord{" +
                ...
                ", actorSenderProfileImage=" + Base64.encodeBase64String(actorSenderProfileImage) + //Arrays.toString(actorSenderProfileImage) +
